...
namespace MainCore.UI.ViewModels.Tabs
{
    ...
    public class AddAccountsViewModel : TabViewModelBase
    {
        ...
        private static AccountDetailDto ParseLine(string input)
        {
            ...
            {
                4 => AccountDetailDto.Create(strAccount[1], url.AbsoluteUri, strAccount[2], strAccount[3]),
                6 => AccountDetailDto.Create(strAccount[1], url.AbsoluteUri, strAccount[2], strAccount[3], int.Parse(strAccount[4]), strAccount[5]),
                8 => AccountDetailDto.Create(strAccount[1], url.AbsoluteUri, strAccount[2], strAccount[3], int.Parse(strAccount[4]), strAccount[5], strAccount[6], strAccount[7]),
                _ => null,
            }; ;
        }
    }
